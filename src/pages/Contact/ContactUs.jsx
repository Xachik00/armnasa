...
const ContactUs = () => {
  return (
    <div className="w-full min-h-[80vh] flex justify-center items-center">
        {/* <div className=' w-[1600px] text-center flex flex-col mx-auto items-center text-white'>
            <h2>Contact Us</h2>
            ...
            <p>Armenian AeroSpace Agency </p>
<span> 15 A.Mikoyan str, Yerevan, Armenia</span>
    <a href="info@armenianasa.org">info@armenianasa.org</a>

                </div>
            </div>
        </div> */}

<body class=" text-gray-100 px-8 py-12"  style={{ background: `url('/Images/gif1.gif')` }}>
      <div class="text-center w-full ">
     
        <img class="w-[30%] h-30 mx-auto" src="./Images/logo.webp" alt="" />
      </div>
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
           ...
           <a href='#' class="underline">info@armenianasa.org</a> 
            </div>
          </div>
