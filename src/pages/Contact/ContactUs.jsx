...
const ContactUs = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url('/Images/gif5.gif')` }}
    >
      <div className="max-w-[1600px]">
        <div className=" text-gray-100 px-2 py-12">
          <div className="  p-2  xl:px-28 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
            <div className="flex w-[100%] justify-center flex-col  md:flex-row md:justify-between ">
              <div className="flex flex-col justify-between max-w-[500px] ">
                <div>
                  <h2 className="text-4xl lg:text-5xl font- bold leading-tight text-blue-500">
                  ...
                  {showEdit !== Contact[0]?.id ? (
                    <>
                      ...
                      <div className="text-gray-700 mt-8 flex flex-col">
                        ...
                        <a
                          ...
                          href="mailto:info@armenianasa.org"
                    ...
                    <>
                      <input
                        type="text"
                        className="text-gray-700 mt-8 flex flex-col border-2 border-black"
                        value={editVal?.title}
                        onChange={(e) =>
                          setEditVal({ ...editVal, title: e.target.value })
                        }
                      />
                      <input
                        type="text"
                        ...
                        value={editVal?.text}
                        onChange={(e) =>
                          setEditVal({ ...editVal, text: e.target.value })
                        }
                      />
                      <input
                        type="email"
                        className={
                          errorMail
                            ? "text-gray-700 mt-8 flex flex-col border-2 border-black"
                            : "text-gray-700 mt-8 flex flex-col border-2 border-red-500' "
                        }
                        value={editVal?.mail}
                        onChange={(e) => {
                  ...
                  {!lng &&
                    ...
                    showEdit !== Contact[0]?.id && (
                      <div className="w-[100px] flex justify-between mt-4">
                        <EditOutlined
                          onClick={() => {
                            setEditVal({ ...Contact[0] });
                            setShowEdit(Contact[0]?.id);
                          }}
                          className=" rounded-xl p-2 hover:bg-blue-500 hover:scale-125"
                        />
                      </div>
                  ...
                  {showEdit !== Contact[1]?.id ? (
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        placeholder={Contact[1]?.text}
                        value={email?.fullName}
                        onChange={(e) =>
                          setEmail({ ...email, fullName: e.target.value })
                        }
                      />
                    </div>
                  ) : (
                  ...
                  {!lng &&
                    ...
                    showEdit !== Contact[1]?.id && (
                      <div>
                        <EditOutlined
                          onClick={() => {
                            setEditVal({ ...Contact[1] });
                            setShowEdit(Contact[1]?.id);
                          }}
                          className=" rounded-xl p-2 hover:bg-blue-500 hover:scale-125"
                        />
                      </div>
                    )}
                  {showEdit !== Contact[2]?.id ? (
                    <div className="mt-8">
                      <span className="uppercase text-sm text-gray-600 font-bold">
                        {Contact[2]?.title}
                      </span>
                  ...
                  {!lng &&
                    ...
                    showEdit !== Contact[2]?.id && (
                      <div>
                        <EditOutlined
                          onClick={() => {
                            setEditVal({ ...Contact[2] });
                            setShowEdit(Contact[2]?.id);
                          }}
                          className=" rounded-xl p-2 hover:bg-blue-500 hover:scale-125"
                        />
                      </div>
                    )}
                  {showEdit !== Contact[3]?.id ? (
                    <div className="mt-8">
                      <span className="uppercase text-sm text-gray-600 font-bold">
                        {Contact[3]?.title}
                      </span>
                  ...
                  {!lng &&
                    ...
                    showEdit !== Contact[3]?.id && (
                      <div>
                        <EditOutlined
                          onClick={() => {
                            setEditVal({ ...Contact[3] });
                            setShowEdit(Contact[3]?.id);
                          }}
                          className=" rounded-xl p-2 hover:bg-blue-500 hover:scale-125"
                        />
                      </div>
                    )}
                  {showEdit !== Contact[4]?.id ? (
                    <div className="mt-8">
                      <button
                        disabled={loading}
                        type="submit"
                  ...
                  {!lng &&
                    ...
                    showEdit !== Contact[4]?.id && (
                      <div>
                        <EditOutlined
                          onClick={() => {
                            setEditVal({ ...Contact[4] });
                            setShowEdit(Contact[4]?.id);
                          }}
                          className=" rounded-xl p-2 hover:bg-blue-500 hover:scale-125"
                        />
                      </div>
