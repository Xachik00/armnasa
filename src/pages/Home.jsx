...
const Home = () => {
  ...
  return (
    <div
      className={lng?"w-[70%]":"  w-full min-h-[60vh] sm:min-h-[80vh] flex justify-center items-center"}
      style={{ background: `url(${Home[0]?.picture})` }}
    >
      <div className={lng?"w-[100%] flex justify-between":" sm:w-[43%] text-center"}>
        { !edit && Home?.map((el, index) => {
          ...
          <h1 className="text-white text-lg text-center mt-4" >Add Translate Data</h1>
          <div className="flex flex-col justify-center items-center w-[100%] mx-auto text-red-500">
